      ...
      >
        {products.map((product) => (
          <div
            ...
            className="flex-shrink-0 min-w-[280px] sm:min-w-[280px] md:min-w-[180px] lg:min-w-[200px] xl:min-w-[220px] border border-gray-200 p-3 sm:p-4 rounded-lg bg-white relative hover:shadow-md transition-shadow duration-200 cursor-pointer"
          >
