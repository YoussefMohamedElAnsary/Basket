        ...
        <div className='w-full'>
                ...
                <div className='flex flex-col text-white text-2xl w-full md:w-1/2 flex-grow'>
                    ...
                    <div className='flex flex-row gap-2 mt-4'>
                        <div className='relative w-full md:max-w-[400px]'>
                            <img src={envelope} alt="envelope" className='absolute left-3 top-1/2 transform -translate-y-1/2' />
                            <input
                                type="text"
            ...
            <div className="w-full bg-[#f8f9fb] font-sans">
                ...
                <div className="w-full flex flex-col md:flex-row justify-between items-center border-b border-gray-200 py-6 md:py-8 px-2 md:px-8 lg:px-20 bg-white">
                    <div className="flex flex-col md:flex-row w-full justify-between items-center text-gray-700 text-base divide-y md:divide-y-0 md:divide-x divide-gray-200">
                        <div className="flex items-center gap-3 px-6 py-3 w-full md:w-auto justify-center">
