  ...
  return (
    <section className="container mx-auto my-10 px-4 flex flex-col lg:flex-row gap-6">
      ...
      <div className="flex flex-col border-2 border-[#ED174A] p-6 w-full lg:w-[330px] h-[700px] cursor-pointer rounded-md">
        ...
        {/* Timer */}
        <div className="flex justify-center lg:justify-start items-center space-x-4 mb-6">
          <span className="text-[20px] text-white font-semibold bg-[#ED174A] rounded-md py-2 px-3">{String(hour).padStart(2, '0')}</span>
          <span className="text-lg font-semibold">:</span>
          <span className="text-[20px] text-white font-semibold bg-[#ED174A] rounded-md py-2 px-3">{String(minute).padStart(2, '0')}</span>
          <span className="text-lg font-semibold">:</span>
          <span className="text-[20px] text-white font-semibold bg-[#ED174A] rounded-md py-2 px-3">{String(second).padStart(2, '0')}</span>
        </div>
        <p className="text-[12px] text-[#C2C2D3]">Remains until the end of the offer</p>
