...
function Shop() {
  ...
  return (
    <div>
      <div className="flex flex-col lg:flex-row justify-start py-5 px-4 md:px-8 lg:px-[180px]">
        {/* Left Sidebar */}
        <div className="flex flex-col justify-start lg:mr-8 mb-6 lg:mb-0 w-full lg:w-auto">
          <ProductCategories
